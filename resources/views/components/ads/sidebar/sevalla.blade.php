<a
    {{ $attributes->class('grid gap-4 p-4 !pt-6 leading-tight bg-orange-50/75 rounded-xl text-orange-900')->merge([
    ...
    <img loading="lazy" src="https://www.gravatar.com/avatar/d58b99650fe5d74abeb9d9dad5da55ad?s=256" alt="Carlos Santos"
        class="mx-auto h-10 rounded-full" />

    <p class="-mt-2 leading-tight text-center"><strong class="font-semibold text-orange-900">“Successful developers
            automate”</strong></p>
    ...
    <img loading="lazy" src="{{ Vite::asset('resources/img/screenshots/sevalla.webp') }}" alt="Sevalla's interface"
