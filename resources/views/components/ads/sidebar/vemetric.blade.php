<a
    {{ $attributes->class('grid gap-4 p-4 !pt-6 leading-tight bg-blue-50/75 text-blue-900 rounded-xl')->merge([
    ...
    <img loading="lazy" src="{{ Vite::asset('resources/img/screenshots/vemetric.webp') }}" alt="Vemetric's dashboard"
