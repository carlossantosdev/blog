<div class="bg-gradient-to-r from-blue-50 to-green-10">
    <div class="relative isolate">
        ...
        <div class="overflow-hidden relative">
            <div class="mx-auto max-w-7xl px-6 pb-8 pt-12 md:pt-12 lg:px-8">
                <div
                    class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center flex flex-col-reverse sm:flex-none gap-20">
                    <x-hero-section.welcome-text />
